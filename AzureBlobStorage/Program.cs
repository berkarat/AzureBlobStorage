...
namespace AzureBlobStorage
{
    public class Program
    {
        ...
        private static async Task CreateandSend()
        {
            ...
            string storageConnectionString = "DefaultEndpointsProtocol=https;AccountName=berkaratlogstorage;AccountKey=cRtOrO8AQugz1p8O+9KS7d/jYOhWeMt1UEc1LM1SlhxvvtVZMrWo1TYwwc7rFRP2CXrdubvu3SoDj67r9cCFbQ==;EndpointSuffix=core.windows.net";
            ...
            try
            {
                ...
                File.WriteAllText(sourceFile, "Hello, berkarat!");
